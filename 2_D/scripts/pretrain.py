...
def main(config):
    ...
    data_loader = config.init_obj('pretrain_data_loader', module_data)
    ...
    criterion = getattr(module_loss, config['pretrain_loss']['type'])
...
if __name__ == '__main__':
    args = argparse.ArgumentParser(description='Cartoon Interpolation Pre Training')
